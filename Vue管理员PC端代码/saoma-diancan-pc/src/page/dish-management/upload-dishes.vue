<template>
	<div class="ordering">
		...
		<div class="content-view-ten" v-loading.fullscreen.lock="loadmen">
			...
			<!-- 库存 -->
			<div class="image-view-title">
				<div class="image-list">库存</div>
				<el-input v-model="stock" type="number" min="0" placeholder="请输入库存数量" :clearable="true"></el-input>
			</div>
			<!-- 食材产地 -->
			<div class="image-view-title">
				<div class="image-list">食材产地</div>
				<el-input v-model="origin" type="text" placeholder="请输入食材产地" :clearable="true"></el-input>
			</div>
			<!-- 菜品详情 -->
			<div class="image-view-title">
				<div class="image-list">菜品详情</div>
				<el-input
					v-model="detail"
					type="textarea"
					:rows="4"
    ...
    this.headers={
      Authorization:localStorage.getItem("token")
		...
		if(JSON.stringify(res) != "{}"){
			this.but = '修改提交'
			this.id = res.item.originalId || res.item.id,
      ...
      this.detail=res.item.detail || '',
      this.origin=res.item.origin || '',
      this.stock=res.item.stock || ''
		}
	},
}
</script>
